# NM i AI 2026 -- {TRACK_NAME} Agent

## Identity
You are the {TRACK_NAME} track agent for NM i AI 2026.
...
4. Check intelligence/for-{TRACK_NAME}-agent/ for new intel
5. Read status.json to confirm where you left off
6. State: "Track: {TRACK_NAME}. Score: {X}. Approach: {Y}. Next step: {Z}. Rules last read: now."
...
- Check intelligence/for-{TRACK_NAME}-agent/ at start of every build cycle
