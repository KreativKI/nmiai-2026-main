...
## Identity
You are the nlp track agent for NM i AI 2026.
...
4. Check intelligence/for-nlp-agent/ for new intel
5. Read status.json to confirm where you left off
6. State: "Track: nlp. Score: {X}. Approach: {Y}. Next step: {Z}. Rules last read: now."
